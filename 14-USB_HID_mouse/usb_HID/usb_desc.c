...
char code CONFIGDESC[41] =
    {
        ...
        0x01, // bNumEndpoints(1);             一个接口，只用输出
        0x03, // bInterfaceClass(HID);
        0x01, // bInterfaceSubClass(Boot);      开启boot
        0x02, // bInterfaceProtocol(mouse);  键盘
        0x00, // iInterface(0);
        ...
        0x34, 0x00, // wDescriptorLength(52);        修改report描述长度

        0x07,       // bLength(7);
        0x05,       // bDescriptorType(Endpoint);
        0x81,       // bEndpointAddress(EndPoint1 as IN);
        0x03,       // bmAttributes(Interrupt);
        0x04, 0x00, // wMaxPacketSize(4);           修改发送报文长度（字节）
        0x0a,       // bInterval(10ms);
};
/*
...
3	Wheel displacement (>0:down; <0:up)
*/
char code HIDREPORTDESC[52] =
    {
        ...
        0x75, 0x05, //    REPORT_SIZE(5);				// 1bit
        0x95, 0x01, //    REPORT_COUNT(1);			// 5个
